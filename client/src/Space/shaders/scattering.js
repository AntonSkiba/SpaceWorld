export const scattering_shader = (function() {
	...
	void _ComputeScattering(
	  ...
	  float planetScale = 20.0; // referencePlanetRadius / planetRadius
	  float atmosphereScale = scaleRatio / 16.0; // referenceRatio
